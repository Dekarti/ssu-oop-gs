...
/**
 * Определеяет класс Машина.<br> <hr>
 *
 * <b>Пример использования:</b>
 * <pre>
 *     // создаем объект машины с текущим запасом топлива равным 140/500, с 92 октановым числом
 *     // и указанным изображением машины, которое задается классом Image,
 ...
 *     System.out.println("До заправки: " + car.getGasolineStocks());
 *
 ...
 *
 *     // выведем текущее значение топлива в консоль
 *     System.out.println("После заправки: " + car.getGasolineStocks() + "\n");
 *
 *     // Выведем текущую координату машины по оси ординат. Она будет равна нулю т.к.
 *     // машине еще не назначена заправочная станция.
 *     System.out.println("Координата по оси ординат до передвижения: " + car.getY());
 *
 ...
 *     System.out.println("Координата по оси ординат после передвижения: " + car.getY());
 *
 ...
 * <b>Вывод:</b><br>
 * До заправки: 140 <br>
 * После заправки: 150 <br>
 * <br>
 * Координата по оси ординат до передвижения: 0 <br>
 * Координата по оси ординат после передвижения: 10 <br>
 * <br>
...
public class Car extends Object {
    ...
    /**
     * Перемещает машину до тех пор пока не встанет позади последней машины в очереди.
     */
